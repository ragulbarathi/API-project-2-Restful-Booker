...
@pytest.mark.smoke
@allure.title("TC4-Verify booking details are not shown for empty booking id")
@allure.description("TC4-Tests the booking details of the user with an empty booking id and status code should be 404, "
                    "this is a negative tc")
@allure.tag("smoke")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_booking_null_booking_id():
...
@pytest.mark.smoke
@allure.title("TC5-Verify booking details are not shown for negative booking id")
@allure.description("TC5-Tests the booking details of the user with an negative number booking id and status code "
                    "should be 404,"
                    "this is a negative tc")
@allure.tag("smoke")
@allure.severity(allure.severity_level.CRITICAL)
...
@pytest.mark.smoke
@allure.title("TC6-Verify booking details are not shown for invalid booking id with special characters.")
@allure.description("TC6-Tests the booking details of the user with an invalid booking id with special characters "
